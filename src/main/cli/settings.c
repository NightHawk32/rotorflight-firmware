...
const char * const lookupTableSwashType[] = {
    "NONE", "PASSTHROUGH", "CP120", "CP135", "CP140", "FP90L", "FP90V", "QUAD", "QUADDC",
};
...
// PG_MIXER_CONFIG
    ...
    { "quad_motor_idle",            VAR_UINT8  | MASTER_VALUE,  .config.minmaxUnsigned = { 0, 250 }, PG_GENERIC_MIXER_CONFIG, offsetof(mixerConfig_t, quad_motor_idle) },
